...
public class RentACatUnitTest {
	...
	public void setUp() throws Exception {
		...
		c2 = Cat.createInstance(InstanceType.MOCK, 2, "Old Dueteronomy");
		...
		System.setOut(new PrintStream(out)); //line from 14.6 of class textbook
	}
	 ...
	 */
	@Test
	public void testGetCatNumCats3() throws NoSuchMethodException, IllegalAccessException {
		r.addCat(c1);
		r.addCat(c2);
		r.addCat(c3);
	...
	public void testListCatsNumCats0() {
		// @Before reconstructs r and none are added
